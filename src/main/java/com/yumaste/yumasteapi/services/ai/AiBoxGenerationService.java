...
public class AiBoxGenerationService {
    ...
    @Autowired
    private YumasteChefAgent yumasteChefAgent;

//    private final BoxRepository boxRepository;
//    private final IngredienteRepository ingredienteRepository;
//    private final ObjectMapper objectMapper = new ObjectMapper();

    public AiGenerateBoxResponseDTO generaBoxAutomatica(AiGenerateBoxRequestDTO requestDTO) {

        return yumasteChefAgent.generaBoxDaRichiesta(requestDTO.suggerimentoOpzionale());
    }
